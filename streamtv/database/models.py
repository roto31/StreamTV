...
class PlayoutMode(str, Enum):
    CONTINUOUS = "continuous"  # Timeline-based continuous playout (HDHomeRun / Plex)
...
# ---------------------------------------------------------------------------
# Download-first caching models
# ---------------------------------------------------------------------------

class CacheStatus(str, Enum):
    """Lifecycle state of a cached media item."""
    QUEUED = "queued"
...
class CachedMedia(Base):
    """Manifest entry tracking a locally-cached media file."""
    ...
    media_item = relationship("MediaItem", backref="cache_entry")
