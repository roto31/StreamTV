...
class MediaItemFromUrl(BaseModel):
    url: str
...
class CollectionBase(BaseModel):
    name: str
    description: Optional[str] = None
    collection_type: Optional[str] = "manual"  # manual and multi supported at playout; smart is UI-disabled
    search_query: Optional[str] = None  # Reserved — smart collections not resolved at playout yet
...
class ScheduleItemBase(BaseModel):
    ...
    # Collection Type
    collection_type: Optional[str] = "collection"  # "collection", "television_show", ... — smart_collection deprecated (use Tunarr proxy)
    collection_id: Optional[int] = None
