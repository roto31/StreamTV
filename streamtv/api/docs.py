...
DOCS_FILES = {
    ...
    # Channel Builder & core operator guides
    "channel_builder": "docs/channel-builder.md",
    "import_vs_builder": "docs/guides/IMPORT_VS_BUILDER.md",
    "archive_org_operator": "docs/guides/ARCHIVE_ORG_OPERATOR.md",
    "pbs_playwright": "docs/guides/PBS_PLAYWRIGHT.md",
